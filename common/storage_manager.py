...
class StorageManager:
    ...
    @classmethod
    def get_instance(cls, snapshot_path: str, version: str, apps: List[str], overlap_snapshot_counts: int):
        if cls._instance is None:
            cls._instance = cls(snapshot_path, version, apps, overlap_snapshot_counts)
